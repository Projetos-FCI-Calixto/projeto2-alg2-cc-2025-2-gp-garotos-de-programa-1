meu professor permitiu o uso de ia para construir o restante do codigo, tirando a recursão, que temos que fazer a nossa propria logica. então você pode me ajudar com o restante, SEM MEXER EM NADA, na função recursiva? mantendo todos os comentarios e lógica, fieis a isso que eu fiz: 
